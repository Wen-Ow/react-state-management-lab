...
// This is the main React component that will handle all the logic and UI
function App() {
  ...
  const [zombieFighters, setZombieFighters] = useState([ // Stores the list of available zombie fighters or characters.
    {
      id: 1,
      name: "Survivor",
      price: 12,
